/**
 * Local vendored copy of the shared DSH client-bundle preset
 * (`~/deepseek-harness/packages/client/tsdown.client.ts`). The only changes
 * from upstream are: relative imports point back into `~/deepseek-harness`,
 * `REPOSITORY_ROOT` is rebased to this repository (the file lives under
 * `packages/itranslation/client/`), and the copy is tracked here because the
 * harness tree is read-only while this project lives outside it.
 */
...
import { optionalStringArray } from '../../../../deepseek-harness/packages/client/modules/src/client/manifest.ts'
import { PLATFORM_MODULES, PRELOADED_CLIENT_EXTERNALS } from '../../../../deepseek-harness/packages/client/web/src/platform.ts'
import { clientBuildEnvironmentDefines } from '../../../../deepseek-harness/scripts/client-build-environment.ts'
